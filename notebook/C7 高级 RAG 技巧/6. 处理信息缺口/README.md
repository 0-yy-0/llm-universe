...
GraphRAG 作为关系型检索扩展放在[让系统选择资料来源](让系统选择资料来源.ipynb)末尾：Notebook 用两条教学手工标注、未经独立人工语义核验的关系边构成最小 fixture，演示实体消歧、受限子图遍历、关系路径映回原文和同范围 BM25 对照。关系字段不是自动抽取结果，边的 `evidence_id/source/page/quote` 均回到 canonical 南瓜书 PDF；结果只说明一个多跳问题的证据边界，不声称全库或普遍提升。
